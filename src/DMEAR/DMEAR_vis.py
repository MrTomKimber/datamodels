...
def DMEAR_vizdiff_to_dot(S1, S2, option_dict=None, graph_options_dict=None):
    ...
    for e,entity in enumerate(obj_dict[class_uri]):
        ...
        content_elements = retrieve_property_meta(S1.union(S2), (L,I,R), entity, URIRef('http://www.semanticweb.org/tomk/ontologies/2022/9/datamodel#ClassContainsAttribute'))
