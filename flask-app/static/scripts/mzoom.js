  ...
  var scroll_zoom = new ScrollZoom($('#xxcontainer'),50000,0.125)
})
...
function ScrollZoom(container,max_scale,factor){
  ...
  var box = target.attr('viewBox');
  console.log(box)
  //var size = { w:box[0], h:box[1]}
  ...
  function update(){
    ...
    //target.attr({'viewBox' : pos.x+', '+ pos.y + ', ' + (box[2] * scale) + ', ' + (box[3] *  scale)})
  }
}
